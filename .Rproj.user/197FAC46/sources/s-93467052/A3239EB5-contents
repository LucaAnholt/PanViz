...
testthat::test_that("tests that GWAS_catalog_tsv_to_dataframe produces a dataframe object and throws correct errors on bad inputs", {
  testthat::expect_equal(class(PanViz::GWAS_catalog_tsv_to_dataframe(file = paste0(find.package("PanViz", lib.loc=NULL, quiet = TRUE), "/data/gwas-association-downloaded_2021-09-13-EFO_1000649.tsv"))), "data.frame")
